...
// Create follow up
leadRouter.post('/followup', handleToken, leadController.createFollowUpController);

// Get all follow ups
leadRouter.get('/followup', handleToken, leadController.getFollowUpController);

// Get follow up by lead ID
leadRouter.get('/followup/:leadId', handleToken, leadController.getFollowUpByLeadIdController);

// Update follow up
leadRouter.put('/followup/:id', handleToken, leadController.updateFollowUpController);

// Delete follow up
leadRouter.delete('/followup/:id',handleToken, leadController.deleteFollowUpController);
